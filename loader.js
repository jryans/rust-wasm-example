...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'rust_wasm-58440ae866b2bb57.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'rust_wasm-58440ae866b2bb57.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'rust_wasm-58440ae866b2bb57.temp.asm.js';
...
var real__add_bob = asm["_add_bob"]; asm["_add_bob"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__add_bob.apply(null, arguments);
};
...
var _add_bob = Module["_add_bob"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_add_bob"].apply(null, arguments) };
